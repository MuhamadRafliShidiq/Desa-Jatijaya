            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>Tentang Kami</h1>
                            <p class="mb-0">Selamat datang di Desa Jatijaya, sebuah desa yang terletak di Kabupaten Tasikmalaya, Jawa Barat. Desa kami dikenal dengan keindahan alamnya yang asri, masyarakat yang ramah, serta kekayaan budaya dan tradisi yang terus dijaga. Sebagai bagian dari pembangunan berkelanjutan, kami berkomitmen untuk meningkatkan kesejahteraan masyarakat melalui berbagai sektor, termasuk pertanian, pendidikan, dan ekonomi kreatif. Dengan semangat gotong royong dan inovasi, Desa Jatijaya terus berkembang untuk menciptakan lingkungan yang harmonis, sejahtera, dan maju. Kami mengundang Anda untuk mengenal lebih jauh potensi desa kami dan bersama-sama membangun masa depan yang lebih baik.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                "clickable": true
                    ...
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide">
                            <img src="<?php echo e(asset('/assets/img/ruangrapat.jpg')); ?>" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="<?php echo e(asset('/assets/img/kantordesa.jpg')); ?>" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="<?php echo e(asset('/assets/img/tamu.jpg')); ?>" alt="">
                        </div>
...
</html><?php /**PATH C:\Users\RAFLI-20031908\Desktop\Desa-Jatijaya\resources\views/profil-desa/tentang-kami.blade.php ENDPATH**/ ?>